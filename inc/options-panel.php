...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Настройки сайта', 'your-textdomain-here' ),
		'id'               => 'basic',
		'desc'             => esc_html__( 'Настройки лэндинга', 'your-textdomain-here' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Картинки сайта', 'your-textdomain-here' ),
		'id'    => 'media',
		'icon'  => 'el el-picture',
	)
);
